...
class FraisHfAdapter extends BaseAdapter {
	...
	public void delHF(final int index, ViewHolder holder){
        holder.cmdSuppHf.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
                String id = lesFrais.get(index).getId().toString();
                RemoveData removeData = new RemoveData();
                removeData.execute(id);
                try {
    ...
    public class RemoveData extends AsyncTask<String, Void, Void> {
